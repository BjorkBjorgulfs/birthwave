    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <div className="flex w-full h-screen justify-center gap-24 py-8 bg-custom-gray items-center">
        ...
        <div className="flex flex-col h-3/4 w-2/6 relative pb-16">
          <div className="flex flex-col h-auto relative overflow-hidden overflow-ellipsis gap-5 ">
            <h2 className="text-2xl">What to expect when having a doula</h2>
            <p className="text-lg leading-8 ">Traditionally, women have long been birth companions for each other and provided invaluable support 
